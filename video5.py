...
class AudioPlayerApp:
    def __init__(self, root):
        ...
        self.vid1bg = ImageTk.PhotoImage(Image.open("images/vid5bg.png").resize((root.winfo_screenwidth(),root.winfo_screenheight())))
    ...
    def play(self):
        if not self.playing:
            pygame.mixer.init()
            pygame.mixer.music.load("sounds/vid5.mp3")
            pygame.mixer.music.play()

            song_info = pygame.mixer.Sound("sounds/vid5.mp3")
