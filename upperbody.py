...
class Upbody():
    ...
    def __init__(self, body):
        self.body = body
        self.body.title("FitInclusive")
        self.body.rowconfigure(0, weight=1)
        self.body.columnconfigure(0, weight=1)
        height = 720
        width = 1280
        x = (self.body.winfo_screenwidth() // 2) - (width // 2)
        y = (self.body.winfo_screenheight() // 2) - (height // 2)
        self.body.geometry('{}x{}+{}+{}'.format(width, height, x, y))
        self.body.resizable(0, 0)
        self.body.config(bg="#291C4F")
        self.myfont = CTkFont(family='Poppins', size=14, weight='bold', slant='italic')

        self.img_path1 = "D:\\PJ 2\\pict\\Upper body.png"
        self.img_path2 = "D:\\PJ 2\\pict\\upbody.png"
        self.img_path3 = "D:\\PJ 2\\pict\\backbutton2.png"
        self.load_image()
        self.main_frame()

        def exit():
            sure = messagebox.askyesno("Exit", "Are you sure you want to exit", parent=self.body)
            if sure:
                self.body.destroy()
        
        self.body.protocol("WM_DELETE_WINDOW", exit)
    ...
    def main_frame(self):
        ...
        frame_utama = CTkFrame(self.body, fg_color="#291C4F", bg_color="#291C4F")
...
class ResultsPage:
    def __init__(self, result_window, total_time, total_calories):
        ...
        self.image_path = "D:\\PJ 2\\gambar\\img.png"  # Path file gambar
...
class Timer:
    def __init__(self, timer):
        ...
        self.exercise_names = ['Dumbell Shoulder Press', 'Tricep Extensions', 'Bicep Curls', 'Chest Press', 'Lateral Raises',
                               'Front Raises', 'Bent-Over Rows', 'Reverse Flyses', 'Wrist Curls', 'Upright Rows']
