...
class Article5 :
    def __init__(self, article5):
        self.article5 = article5
        self.folder_path = "D:/pythonProject1"
        self.article5.rowconfigure(0, weight=1)
        self.article5.columnconfigure(0, weight=1)
        height = 720
        width = 1280
        x = (self.article5.winfo_screenwidth() // 2) - (width // 2)
        y = (self.article5.winfo_screenheight() // 4) - (height // 4)
        self.article5.geometry('{}x{}+{}+{}'.format(width, height, x, y))
        self.article5.config(bg="white")
        self.article5.last_keypress_time = 0
        self.article5.double_tap_interval = 0.3
        self.article5.attributes("-fullscreen", True)
        self.article5.bind("<Escape>", self.exit_fullscreen)
        self.article5.bind("<Double-Button-1>", self.toggle_fullscreen)
        self.file_titles = {
        ...
        self.img2 = self.img2.resize((self.article5.winfo_screenwidth(), self.article5.winfo_screenheight()))
        self.foto1 = ImageTk.PhotoImage(self.img2)
        self.page1 = Canvas(self.article5, width=self.article5.winfo_screenwidth(),
                             height=self.article5.winfo_screenheight(),
        ...
        def listenow():
            ...
            winapp = audio5.TextToSpeechApp(win)
            win.title("")
            win.lift()
            win.focus_force()
        ...
        self.scrframe = CTkScrollableFrame(self.article5,
                                           orientation="vertical",
                                           width=self.article5.winfo_screenwidth(),
                                           height=700,
                                           fg_color='white',
                                           bg_color='white',
                                           )
        ...
        self.img1 = Image.open("images\\page4 (1).png")
        self.img1 = self.img1.resize((self.article5.winfo_screenwidth(), self.article5.winfo_screenheight()))
        self.foto = ImageTk.PhotoImage(self.img1)
        self.page2 = Canvas(self.scrframe, width=self.article5.winfo_screenwidth(),
                            height=self.article5.winfo_screenheight(),
        ...
        def linkarticle():
            webbrowser.open_new("https://www.ucsfhealth.org/education/improve-your-sleep-hygiene")

        button_source = Button(self.page2, text="https://www.ucsfhealth.org/education/improve-your-sleep-hygiene"
                               ,bg="white", fg="blue", borderwidth=0, activebackground='white', font=("Helvetica",9),command=linkarticle)
        button_source.place(x=150, y=401)

        self.articlebg = Image.open('images\\page4 (2).png')
        self.articlebg = self.articlebg.resize((self.article5.winfo_screenwidth(), self.article5.winfo_screenheight()))
        self.photo = ImageTk.PhotoImage(self.articlebg)
        self.page3 = Canvas(self.scrframe, width=self.article5.winfo_screenwidth(),
                              height=self.article5.winfo_screenheight(),
        ...
        self.medbg = self.medbg.resize((self.article5.winfo_screenwidth(), self.article5.winfo_screenheight()))
        self.medphoto = ImageTk.PhotoImage(self.medbg)
        self.page4 = Canvas(self.scrframe, width=self.article5.winfo_screenwidth(),
                             height= 370,
                             bg="#C7DFDF", highlightthickness=0, )
    ...
    def toggle_fullscreen(self, event=None):
        ...
        if current_time - self.article5.last_keypress_time < self.article5.double_tap_interval:
            self.last_keypress_time = 0
            is_fullscreen = self.article5.attributes("-fullscreen")
            self.article5.attributes("-fullscreen", not is_fullscreen)
        else:
            self.article5.last_keypress_time = current_time

    def exit_fullscreen(self, event):
        if self.article5.attributes("-fullscreen"):
            self.article5.attributes("-fullscreen", False)
