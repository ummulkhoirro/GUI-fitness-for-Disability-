...
programs_dict = {
    "Monday": [
        {
            "name": "Sensory Stetching",
            "path": os.path.join(base_path, "gambar", "D:\\pythonProject1\\gambar\\SS.png"),
            "video": os.path.join(base_path, "video", "D:\\pythonProject1\\video\\Sensory Stretching.mp4"),
            "audio": os.path.join(base_path, "audio", "D:\\pythonProject1\\audio\\Sensory Stretching.mp3"),
            "label": [
                "1. Light warm-up like walking in place or arm swings for 1-2 minutes.",
                "2. Follow dynamic stretches from the video to improve flexibility.",
                "3. End with static stretches, holding each for 15-30 seconds."
            ]
        }
    ],
    "Tuesday": [
        {
            "name": "Therapy ball",
            "path": os.path.join(base_path, "gambar", "D:\\pythonProject1\\gambar\\therapy.png"),
            "video": os.path.join(base_path, "video", "D:\\pythonProject1\\video\\therapy.mp4"),
            "audio": os.path.join(base_path, "audio", "D:\\pythonProject1\\audio\\therapy.mp3"),
            "label": [
                "1. Light warm-up like arm swings or walking in place for 1-2 minutes.",
                "2. Follow animal-like movements from the video.",
                "3. End with static stretches."
            ]
        },
        {
            "name": "Basic",
            "path": os.path.join(base_path, "gambar", "D:\\pythonProject1\\gambar\\basic.png"),
            "video": os.path.join(base_path, "video", "D:\\pythonProject1\\video\\basic.mp4"),
            "audio": os.path.join(base_path, "audio", "D:\\pythonProject1\\audio\\basic.mp3"),
            "label": [
                "1. Warm-up like walking in place or arm swings for 1-2 minutes.",
                "2. Follow basic exercises shown in the video.",
    ...
    "Thursday": [
        {
            ...
            "label": [
                "1. Sit comfortably with a straight back and feet on the floor.",
                "2. Follow the seated movements from the video.",
    ...
    "Saturday": [
        {
            "name": "Animal walk",
            "path": os.path.join(base_path, "gambar", "D:\\pythonProject1\\gambar\\walk.png"),
            "video": os.path.join(base_path, "video", "D:\\pythonProject1\\video\\walk.mp4"),
            "audio": os.path.join(base_path, "audio", "D:\\pythonProject1\\audio\\walk.mp3"),
            "label": [
                "1. Light warm-up like arm swings or walking in place for 1-2 minutes.",
                "2. Follow animal-like movements from the video."
                "3. End with static stretches."
