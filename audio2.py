...
class TextToSpeechApp:
    def __init__(self, root):
        ...
        style.configure("custom.Horizontal.TProgressbar", background="red", thickness=3)
    ...
    def play(self):
        if not self.playing:
            pygame.mixer.init()
            pygame.mixer.music.load("sounds/A2.mp3")
            pygame.mixer.music.play()

            song_info = pygame.mixer.Sound("sounds/A2.mp3")
