...
class Article7 :
    def __init__(self, article7):
        self.article7 = article7
        self.folder_path = "D:/pythonProject1"
        self.article7.rowconfigure(0, weight=1)
        self.article7.columnconfigure(0, weight=1)
        height = 720
        width = 1280
        x = (self.article7.winfo_screenwidth() // 2) - (width // 2)
        y = (self.article7.winfo_screenheight() // 4) - (height // 4)
        self.article7.geometry('{}x{}+{}+{}'.format(width, height, x, y))
        self.article7.config(bg="white")
        self.article7.last_keypress_time = 0
        self.article7.double_tap_interval = 0.3
        self.article7.attributes("-fullscreen", True)
        self.article7.bind("<Escape>", self.exit_fullscreen)
        self.article7.bind("<Double-Button-1>", self.toggle_fullscreen)
        self.file_titles = {
        ...
        self.img2 = self.img2.resize((self.article7.winfo_screenwidth(), self.article7.winfo_screenheight()))
        self.foto1 = ImageTk.PhotoImage(self.img2)
        self.page1 = Canvas(self.article7, width=self.article7.winfo_screenwidth(),
                             height=self.article7.winfo_screenheight(),
        ...
        def listenow():
            ...
            winapp = audio7.TextToSpeechApp(win)
            win.title("")
            win.lift()
            win.focus_force()
        ...
        self.scrframe = CTkScrollableFrame(self.article7,
                                           orientation="vertical",
                                           width=self.article7.winfo_screenwidth(),
                                           height=700,
                                           fg_color='white',
                                           bg_color='white',
                                           )
        ...
        self.img1 = Image.open("images\\page6 (1).png")
        self.img1 = self.img1.resize((self.article7.winfo_screenwidth(), self.article7.winfo_screenheight()))
        self.foto = ImageTk.PhotoImage(self.img1)
        self.page2 = Canvas(self.scrframe, width=self.article7.winfo_screenwidth(),
                            height=self.article7.winfo_screenheight(),
        ...
        def linkarticle():
            webbrowser.open_new("https://www.ucsfhealth.org/education/stress-and-heart-disease")

        button_source = Button(self.page2, text="https://www.ucsfhealth.org/education/stress"
                               ,bg="white", fg="blue", borderwidth=0, activebackground='white', font=("Helvetica",9),command=linkarticle)
        button_source.place(x=150, y=487)

        self.articlebg = Image.open('images\\page6 (2).png')
        self.articlebg = self.articlebg.resize((self.article7.winfo_screenwidth(), self.article7.winfo_screenheight()))
        self.photo = ImageTk.PhotoImage(self.articlebg)
        self.page3 = Canvas(self.scrframe, width=self.article7.winfo_screenwidth(),
                              height=self.article7.winfo_screenheight(),
        ...
        self.medbg = Image.open('images\\page6 (3).png')
        self.medbg = self.medbg.resize((self.article7.winfo_screenwidth(), self.article7.winfo_screenheight()))
        self.medphoto = ImageTk.PhotoImage(self.medbg)
        self.page4 = Canvas(self.scrframe, width=self.article7.winfo_screenwidth(),
                             height=self.article7.winfo_screenheight(),
                             bg="#C7DFDF", highlightthickness=0, )
        self.page4.pack(pady=0, fill='both', expand=True)
        self.page4.create_image(0, 0, anchor='nw', image=self.medphoto)

        self.bmibg = Image.open('images\\page6 (4).png')
        self.bmibg = self.bmibg.resize((self.article7.winfo_screenwidth(), self.article7.winfo_screenheight()))
        self.photo1 = ImageTk.PhotoImage(self.bmibg)
        self.page5 = Canvas(self.scrframe, width=self.article7.winfo_screenwidth(),
                             height=self.article7.winfo_screenheight(),
                             bg="black", highlightthickness=0)
        self.page5.pack(pady=0, fill='both', expand=True)
        self.page5.create_image(0, 0, anchor='nw', image=self.photo1)

        self.newsimg = Image.open('images\\page6 (5).png')
        self.newsimg = self.newsimg.resize((self.article7.winfo_screenwidth(), self.article7.winfo_screenheight()))
        self.photonews = ImageTk.PhotoImage(self.newsimg)
        self.page6 = Canvas(self.scrframe, width=self.article7.winfo_screenwidth(),
                              height=self.article7.winfo_screenheight(),
                              bg="white", highlightthickness=0)
        self.page6.pack(pady=0, fill='both', expand=True)
        self.page6.create_image(0, 0, anchor='nw', image=self.photonews)

        self.page7img = Image.open('images\\page3 (11).png')
        self.page7img = self.page7img.resize((self.article7.winfo_screenwidth(), self.article7.winfo_screenheight()))
        self.photopage7 = ImageTk.PhotoImage(self.page7img)
        self.page7 = Canvas(self.scrframe, width=self.article7.winfo_screenwidth(),
                              height=self.article7.winfo_screenheight(),
                              bg="white", highlightthickness=0)
    ...
    def toggle_fullscreen(self, event=None):
        ...
        if current_time - self.article7.last_keypress_time < self.article7.double_tap_interval:
            self.last_keypress_time = 0
            is_fullscreen = self.article7.attributes("-fullscreen")
            self.article7.attributes("-fullscreen", not is_fullscreen)
        else:
            self.article7.last_keypress_time = current_time

    def exit_fullscreen(self, event):
        if self.article7.attributes("-fullscreen"):
            self.article7.attributes("-fullscreen", False)
